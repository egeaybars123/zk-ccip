...
contract Messenger is CCIPReceiver, OwnerIsCreator {
    ...
    address constant verifierContractAddr = 0x5B9200541FEA2C8E03f630b201C2571b0f90a077;
    ...
    ZKMessage lastReceivedProof; // Store the last received text.
    ...
    function _ccipReceive(
        ...
        internal
        override
         //Remove checking for the whitelisted status of the sender for testing purposes.
    {   
        ZKMessage memory proofData = abi.decode(any2EvmMessage.data, (ZKMessage));
        IVerification.Proof memory _proof = IVerification.Proof(proofData.proof.a, proofData.proof.b, proofData.proof.c);
        lastReceivedMessageId = any2EvmMessage.messageId; // fetch the messageId
        lastReceivedProof = abi.decode(any2EvmMessage.data, (ZKMessage)); // abi-decoding of the sent text

        bool result = IVerification(verifierContractAddr).verifyTx(_proof, proofData.input);
        sendMessagePayLINK(16015286601757825753, 0x0464c33a9BCE1f3e8c87489E620e34a9D5994e39, result); //Ethereum Sepolia
        //Implement on Optimism? We can utilize Optimism's Cross-Domain Messaging L1 so that sending to the executing chain is cheaper for the users.
    }
    ...
    function _buildCCIPMessage(
        ...
        Client.EVM2AnyMessage memory evm2AnyMessage = Client.EVM2AnyMessage({
            ...
            data: abi.encode(result), // ABI-encoded string
    ...
    function getLastReceivedMessageDetails()
        external
        view
        returns (bytes32 messageId, ZKMessage memory)
    {
        return (lastReceivedMessageId, lastReceivedProof);
    }
