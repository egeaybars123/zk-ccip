...
contract Messenger is CCIPReceiver, OwnerIsCreator {
    ...
    IVerification.Proof lastReceivedProof; // Store the last received text.
    ...
    function sendMessagePayLINK(
        uint64 _destinationChainSelector,
        address _receiver,
        IVerification.Proof memory _proof
    )
        external
        onlyOwner
        ...
        onlyWhitelistedSenders(abi.decode(any2EvmMessage.sender, (address))) // Make sure the sender is whitelisted
    {
        ...
        lastReceivedProof = abi.decode(any2EvmMessage.data, (IVerification.Proof)); // abi-decoding of the sent text
    ...
    function getLastReceivedMessageDetails()
        external
        view
        returns (bytes32 messageId, IVerification.Proof memory)
    {
